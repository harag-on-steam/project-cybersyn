...
if mods["nullius"] then
	...
	data.raw["recipe"][OLD_COMBINATOR_NAME].subgroup = data.raw["train-stop"]["train-stop"].subgroup
	data.raw["item"][OLD_COMBINATOR_NAME].subgroup = data.raw["item"]["train-stop"].subgroup
